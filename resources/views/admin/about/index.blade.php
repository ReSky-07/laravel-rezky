        ...
        <div class="container-fluid px-4">
            ...
            <div class="card mb-4">
                <div class="card-header">
                    ...
                    About Content Table
                    <a href="{{ route('admin.about.create') }}" class="btn btn-primary btn-sm float-end">Add New</a>
                </div>
                <div class="card-body">
                    <table id="datatablesSimple" class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <img src="{{ asset('storage/' . $about->photo) }}" alt="Photo" style="width: 100px; height: auto;">
                                </td>
                                <td>{{ $about->title }}</td>
                                <td>{{ Str::limit($about->subtitle, 50) }}</td>
                                <td>
                                    <a href="{{ route('admin.about.edit', $about->id) }}" class="btn btn-warning btn-sm">Edit</a>
                                    <form action="{{ route('admin.about.destroy', $about->id) }}" method="POST" class="delete-form" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
